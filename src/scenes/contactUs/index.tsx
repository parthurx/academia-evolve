...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id='contate-nos' className='mx-auto w-5/6 pt-24 pb-32'>
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            <div className='mt-10 justify-between gap-8 md:flex '>
                ...
                >
                    ...
                    target='_blank'
                    onSubmit={onSubmit}
                    action="https://formsubmit.co/machineyordle@gmail.com"
                    method="POST"
                    >
                        <input 
                        ...
                        {errors.name && (
                            <p className='mt-1 text-primary-500'>
                                ...
                                {errors.name.type === 'maxLength' && 'O máximo de caracteres é 100.'}
                            </p>
                        )}
                    ...
                    <textarea 
                        ...
                        {errors.message && (
                            <p className='mt-1 text-primary-500'>
                                ...
                                {errors.message.type === 'maxLength' && 'O máximo de caracteres é 2000.'}
                            </p>
                        )}
                        <button
                        type='submit'
