...
const benefits: Array<BenefitType> = [
    {
        ...
        title: "Instruções de última geração",
    ...
    },
    {
        ...
        title: "Mais de 100 aulas diversas",
        ...
        >
            ...
            >
                ...
                <p className="my-5 text-sm">
                    Fornecemos equipamentos fitness de padrão mundial, 
                    treinadores e aulas para levá-lo a seus objetivos fitness com maior facilidade.
                    O verdadeiro cuidar de cada músculo do seu corpo.
                </p>
            </motion.div>
            {/* BENEFITS */}
            <motion.div
                ...
                <div>
                    ...
                    <div className="relative">
                        <div className="before:absolute before:-top-20 before:-left-20 before:z-[-1] before:content-abstractwaves">
                            ...
                            >
                                <HText>MILHÕES DE MEMBROS FELIZES FICANDO EM{" "}
                                <span className="text-primary-500">FORMA</span>
                                </HText>
                            </motion.div>
                        </div>
